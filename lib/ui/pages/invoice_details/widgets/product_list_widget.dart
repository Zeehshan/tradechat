...
class ProductListWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<MyInvoicesController>(builder: (controller) {
      return Column(
        children: [
          Container(
          ...
          Column(
            children: List.generate(
                controller.selectedInvoice!.bundle!.orderProducts.length,
                (index) {
              final product =
                  controller.selectedInvoice!.bundle!.orderProducts[index];
              final subPrice =
